...
namespace Matlab.Api.Controllers
{
	...
	public class AccountController : ApiController
	{
		...
		public async Task<IHttpActionResult> Register(RegisterBindingModel model)
		{
			...
			var user = new ApplicationUser() { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, PhoneNumber = model.Mobile, PhoneNumberConfirmed = false };
			...
			var changePhoneNumberToken = UserManager.GenerateChangePhoneNumberToken(user.Id, model.Mobile);
			if (UserManager.SmsService != null)
			{
				var message = new IdentityMessage
				{
					Destination = model.Mobile,
					Body = "Your security code is: " + changePhoneNumberToken
				};
				// Send token
