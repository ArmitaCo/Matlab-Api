...
namespace Matlab.Logger
{
	public static class LogThis
	{
		...
		public static void VerificationCode(string code,string mobile)
		{
			BaseLog(LogLevel.Debug, new Dictionary<LogProperties, object>()
			{
				{LogProperties.Action,"کد موبایل" },
				{LogProperties.Message,code },
				{LogProperties.User, mobile}
			});
		}
